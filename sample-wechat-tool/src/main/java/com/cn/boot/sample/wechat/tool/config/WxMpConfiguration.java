package com.cn.boot.sample.wechat.tool.config;

import com.cn.boot.sample.wechat.tool.handler.*;
...
public class WxMpConfiguration {
    ...
    private final TemplateSendResultHandler templateSendResultHandler;
    ...
    public WxMpMessageRouter messageRouter(WxMpService wxMpService) {
        ...
        // 模板消息回调事件
        newRouter.rule().async(false).msgType(EVENT).event(EventType.TEMPLATE_SEND_JOB_FINISH).handler(this.templateSendResultHandler).end();
