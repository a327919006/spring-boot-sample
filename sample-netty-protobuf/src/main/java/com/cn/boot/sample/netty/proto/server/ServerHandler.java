package com.cn.boot.sample.netty.proto.server;
...
public class ServerHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        try {
            ReqDeviceData.DeviceData data = (ReqDeviceData.DeviceData) msg;
            String channelId = ctx.channel().id().asShortText();
            String ip = ClientUtils.getClientIpAddress(ctx);
     ...
     * 业务上记录设备连接
     */
    private void handleDeviceConnection(ReqDeviceData.DeviceData data, ChannelHandlerContext ctx) {
        // 添加设备到连接池
